...
picArray.forEach(pic =>{
  ...
  article.setAttribute('id',`article${num}`)
  ...
  num++
  const cancelButton = document.getElementById("modalImg");
  const dialog = document.getElementById("favDialog");
  dialog.returnValue = "favAnimal";
  article.addEventListener('click', ()=>{
    dialog.showModal();
    let modalPic = document.getElementById('modalImg');
    modalPic.src=pic.image.large;
    modalPic.alt = pic.title;
  });
...
// document.querySelector('#article').forEach(item =>{
